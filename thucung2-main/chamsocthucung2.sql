...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 10, 2024 lúc 03:30 AM
...
--
-- Cơ sở dữ liệu: `chamsocthucung2`
--
-- --------------------------------------------------------
CREATE DATABASE IF NOT EXISTS `chamsocthucung2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `chamsocthucung2`;
--
