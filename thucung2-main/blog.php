...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link text-white" href="chitietblog.php">tin tức</a>
      </li>
      <li class="nav-item">
    ...
    <div class="container-fluid fruite py-5">
      <div class="container py-5">
        <h1>thông tin chăm sóc thú cưng</h1>
      ...
      <div class="col-md6 col-lg-4 col-xl-3">
                      <div class="card">
                        <a href="chitietblog.php?sid=<?php echo $r['id'];?>">
                        <td><img
                          class="card-img-top"
                          src="./img/blog/<?php echo $r['hinhanh']; ?>"
                          alt="Card image"
                        /></td>
                        <div class="card-body">
                          <h4 class="card-title">
                          ...
                          <p class="card-text"><?php echo $r['tacgia'];?></p>
